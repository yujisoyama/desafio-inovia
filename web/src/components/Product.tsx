...
export const Product = ({ id, imagem, nome, sobre, preco, marca, estoque }: IProductProps) => {
    const navigate = useNavigate();

    return (
        <div onClick={() => navigate(`/produto/${id}`)} className="w-72 rounded-md border-2 border-highlight bg-background p-4 font-noto text-main flex flex-col gap-2 hover:cursor-pointer hover:shadow-[0px_0px_10px_0px_#1de9b6] duration-150">
